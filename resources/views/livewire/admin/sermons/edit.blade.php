<x-card g-component="SermonEdit">
    ...
    <ul class="nav nav-pills my-4" id="pills-tab" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" id="pills-image_cover-tab" data-bs-toggle="pill" href="#pills-image_cover"
                role="tab" aria-controls="pills-image_cover" aria-selected="true">
                {{ __("Image couverture") }}
            </a>
        </li>
        <li class="nav-item" role="presentation">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="pills-audios-tab" data-bs-toggle="pill" href="#pills-audios" role="tab"
                aria-controls="pills-audios" aria-selected="false">
                {{ __("Audios") }}
            </a>
        </li>
        <li class="nav-item" role="presentation">
    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane show active" id="pills-image_cover" role="tabpanel"
            aria-labelledby="pills-image_cover-tab">
            <div class="row">
        ...
        <div class="tab-pane" id="pills-audios" role="tabpanel" aria-labelledby="pills-audios-tab">
            <div class="row">
                <div class="col-lg-6">
        ...
        <div class="tab-pane" id="pills-documents" role="tabpanel" aria-labelledby="pills-documents-tab">
            <div class="row">
                <div class="col-lg-6">
